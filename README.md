...
![HomeCleanerBot](docs/images/robot_design.png)

## Features

- **2+1 House Layout**: Custom SDF world with realistic room arrangement
...
### World Model
The `house.world` file defines a 2+1 layout with:
- Two bedrooms
- Living room
- Corridors
